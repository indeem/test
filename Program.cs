        ...
        public class FahrzeugeProgramm
        {
            ...
            class Menü
            {
                ...
                static int prüfenAufGanzzahl()
                {
                    ...
                    if (eingabeAuswahlEingabe == "")
                    {
                        eingabeZurück = -2;
                    }
                    else
                    {
                        //Prüfen ob Auswahl 0 ist
                        if (Auswahl == 0)
                        {
                            //Prüfen ob eingabeAuswahlEingabe Stopp ist
                            if (eingabeAuswahlEingabe == "Stopp")
                            {
                                //initialisieren der Variablen programmStopp
                                programmStopp = "Stopp";
                            }
                            else
                            {
                                ...
                                {
                                    //initialisieren der Variablen eingabeAuswahl
                                    eingabeAuswahl = -1;
                                }
                                else
                                {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        //prüfen ob die Variable Auswahl = 5 ist
                                        if (Auswahl == 5)
                                        {
                                            //Aufrufen einer while-Schleife
                                            while (erfolg == false)
